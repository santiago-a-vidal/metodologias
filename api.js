...
let value = ubicacion["lat"];
  // console.log(`${key}: ${value}`);


    let latitud = "{lat: " + -37.330662;
    let longitud = "lng: " + -59.121555 + "}";
    ...
    addMarkerToGroup(group, {lat: -37.330662, lng: -59.128889},
        ...
        addMarkerToGroup(group, (ubicacion{lat} : ubicacion{value}),ubicacion["lng"],informacion);
...
>>>>>>> 019fbbdc135c6e7cbb5935c44c0483e34225aba5
